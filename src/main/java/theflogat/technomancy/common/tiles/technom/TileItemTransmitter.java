                        ...
                        if (tile != null && !tile.isInvalid() && tile instanceof IInventory) {
                            ...
                            if (chestBlock instanceof BlockChest) {
                                ...
                                if (worldObj.getBlock(coords.posX - 1, coords.posY, coords.posZ) == chestBlock) {
                                    rem = new InventoryLargeChest("container.chestDouble", (TileEntityChest) worldObj.getTileEntity(coords.posX - 1, coords.posY, coords.posZ), rem);
                                }

                                if (worldObj.getBlock(coords.posX + 1, coords.posY, coords.posZ) == chestBlock) {
                                    rem = new InventoryLargeChest("container.chestDouble", rem, (TileEntityChest) worldObj.getTileEntity(coords.posX + 1, coords.posY, coords.posZ));
                                }

                                if (worldObj.getBlock(coords.posX, coords.posY, coords.posZ - 1) == chestBlock) {
                                    rem = new InventoryLargeChest("container.chestDouble", (TileEntityChest) worldObj.getTileEntity(coords.posX, coords.posY, coords.posZ - 1), rem);
                                }

                                if (worldObj.getBlock(coords.posX, coords.posY, coords.posZ + 1) == chestBlock) {
                                    rem = new InventoryLargeChest("container.chestDouble", rem, (TileEntityChest) worldObj.getTileEntity(coords.posX, coords.posY, coords.posZ + 1));
                                }
                            } else {
                                rem = (IInventory) tile;
                            }
