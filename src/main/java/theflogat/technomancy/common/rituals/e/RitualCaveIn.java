                ...
                for (int zz = -radiusZ; zz <= radiusZ; zz++) {
                    if (!w.isAirBlock(x + xx, yy, z + zz)) {
                        if (w.getTileEntity(x + xx, yy, z + zz) == null) {
                            ...
                            for (int i = 0; i < yy; i++) {
                                if (w.isAirBlock(x + xx, i, z + zz) || w.getBlock(x + xx, i, z + zz).canReplace(w, x + xx, i, z + zz, w.getBlockMetadata(x + xx, i, z + zz), new ItemStack(b))) {
                            ...
                            if (MovableTileRegistry.allowed.contains(w.getTileEntity(x + xx, yy, z + zz).getClass())) {
                                ...
                                te.writeToNBT(comp);
                                for (int i = 0; i < yy; i++) {
                                    if (w.isAirBlock(x + xx, i, z + zz) || w.getBlock(x + xx, i, z + zz).canReplace(w, x + xx, i, z + zz, w.getBlockMetadata(x + xx, i, z + zz), new ItemStack(w.getBlock(x + xx, yy, z + zz)))) {
