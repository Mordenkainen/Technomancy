...
public class RitualExtraction extends Ritual {
    ...
    public void applyEffect(World w, int x, int y, int z) {
        ...
        ArrayList<EntityLivingBase> l = (ArrayList<EntityLivingBase>) w.getEntitiesWithinAABB(EntityLivingBase.class, AxisAlignedBB.getBoundingBox(x - 5, y - 5, z - 5, x + 5, y + 5, z + 5));
        if (!l.isEmpty()) {
