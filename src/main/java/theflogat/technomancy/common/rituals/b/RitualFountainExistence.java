...
public class RitualFountainExistence extends Ritual implements IRitualEffectHandler {
    ...
    public void applyEffect(TileCatalyst te) {
        if (((Integer) te.data[0]).intValue() >= 1000) {
            ...
            ArrayList<EntityLivingBase> e = (ArrayList<EntityLivingBase>) te.getWorldObj().getEntitiesWithinAABB(EntityLivingBase.class, AxisAlignedBB.getBoundingBox(te.xCoord - 11, te.yCoord - 11, te.zCoord - 11, te.xCoord + 11, te.yCoord + 11, te.zCoord + 11));
