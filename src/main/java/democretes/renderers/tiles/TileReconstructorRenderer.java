package democretes.renderers.tiles;
...
import democretes.renderers.models.ModelReconstructor;
...
public class TileReconstructorRenderer extends TileEntitySpecialRenderer{
	...
	public void renderTileEntityAt(TileEntity entity, double x, double y, double z, float f) {
		...
		if(rec.worldObj != null && rec.getStackInSlot(0) != null) {
			GL11.glPushMatrix();
//			float rotation = System.currentTimeMillis() & 0b111;
			EntityItem ghost = new EntityItem(rec.worldObj);
...
//			GL11.glRotatef(rotation, 0.0F, 1.0F, 0.0F);
			itemRenderer.doRenderItem(ghost, 0, 0, 0, 0, 0);
			GL11.glPopMatrix();
		}
